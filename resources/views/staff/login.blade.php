...
<head>
    ...
    <title>U-rang - Staff Panel v1.0</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="{{ route('post-staff-login') }}"  method="post">
                            <fieldset>
                                ...
                                <button type="submit" name="admin-login-btn" class="btn btn-lg btn-success btn-block">Sign In</button>
