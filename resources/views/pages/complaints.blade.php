...
@section('content')
	<section class="top-header complaints-us-header with-bottom-effect transparent-effect dark dark-strong">
            <div class="bottom-effect"></div>
            <div class="header-container">	
                <div class="header-title">
                    <div class="header-icon"><span class="icon icon-Wheelbarrow"></span></div>
                    <div class="title">Customer Complaints</div>
                    <em>Send Us a Message Instead</em>
                </div>
            </div><!--container-->
        </section>  
                        ...
                        <div class="contact-form">
                            ...
                            <form method="post" action="{{ route('postComplaints') }}" name="contact-form" id="contact-form">
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="number" name="phone" id="phone" placeholder="PHONE NO." class="form-control" required/>
                                        </div>
                                    </div> 
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <textarea class="form-control" name="message"  placeholder="your complaints"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group"> 
