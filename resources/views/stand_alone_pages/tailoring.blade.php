...
<div class="row">
  <div class="col-md-8 dryclean">
      <h2><span class="glyphicon glyphicon-home" aria-hidden="true"></span>{{$page_data != null && $page_data->page_heading != null ? $page_data->page_heading : "Tailoring"}}</h2>
      <h3>{{$page_data != null && $page_data->tags != null ? $page_data->tags : "U-Rang 2016 #1 Tailoring in US"}}</h3>
      <hr>
      ...
      @endif
      <div>{!! $page_data != null && $page_data->content != null ? $page_data->content : "Tailoring Page" !!}</div>
  </div>
  <div class="col-md-4">
