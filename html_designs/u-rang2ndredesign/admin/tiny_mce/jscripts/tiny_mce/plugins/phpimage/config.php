...
if ($_SERVER['SERVER_NAME']=="localhost") {
	...
	/*$user = DB_USER; //Database Username here
	$pass = DB_PASSWORD; //Database Password here
	$db = DB_NAME; //Database Name here
	$localhost=DB_HOST; //Database Server*/
...
$sql=mysql_query("select site_url from ur_config where 1=1");
...
$server_image_directory		= $_cur_dir.'images/uploaded/';  //e.g. '/home/user/public_html/uploads'; 

// URL directory to stored images (relative or absoulte) - IMPORTANT CHANGE PATH TO SUIT YOUR NEEDS!!!
if($_SERVER['SERVER_NAME'] == "localhost") {
$url_image_directory			= $site_url.'/urang/web/images/uploaded'; 
} else {
$url_image_directory			= $site_url.'/images/uploaded'; 
}
